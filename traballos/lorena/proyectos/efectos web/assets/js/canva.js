...
function onMove(event) {
  ...
  // Ajusta las coordenadas del cursor para que el punto de referencia sea el centro del canvas
  end.x = event.clientX - rect.left;
  end.y = event.clientY - rect.top;
...
//   }
  ...
  drawCurve([start, elastic, end], '#252928');
}
